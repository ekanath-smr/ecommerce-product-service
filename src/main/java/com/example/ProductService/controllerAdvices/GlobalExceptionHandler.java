...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            ...
            InvalidParentCategoryId.class,
            InvalidParentCategoryName.class
    })
    public ResponseEntity<ErrorResponseDto> handleCategoryNotFoundExceptions(
            RuntimeException ex) {
    ...
    @ExceptionHandler({
            ...
            InvalidParentAssignmentException.class,
            CannotDeleteParentCategoryException.class
    })
    public ResponseEntity<ErrorResponseDto> handleCategoryBusinessRuleViolations(
            RuntimeException ex) {
